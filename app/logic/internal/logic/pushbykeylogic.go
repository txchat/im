...
func (l *PushByKeyLogic) PushByKey(in *logic.PushByKeyReq) (*logic.Reply, error) {
	reply, err := l.pushByKey(l.ctx, in.GetAppId(), in.GetToKey(), &protocol.Proto{
...
func (l *PushByKeyLogic) pushByKey(c context.Context, appId string, keys []string, p *protocol.Proto) (reply *cometclient.ListCastReply, err error) {
