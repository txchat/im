...
func (l *PushByUIDLogic) PushByUID(in *logic.PushByUIDReq) (*logic.Reply, error) {
	reply, err := l.pushByUID(l.ctx, in.GetAppId(), in.GetToId(), &protocol.Proto{
...
func (l *PushByUIDLogic) pushByUID(c context.Context, appId string, toIds []string, p *protocol.Proto) (reply *cometclient.ListCastReply, err error) {
